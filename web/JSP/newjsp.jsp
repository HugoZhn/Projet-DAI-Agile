                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="precisionEx" placeholder="Précision Exercice *" value="<%=ex.getTempsBaseEx()%>" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Description Exercice :</label>
                                            <input type="text" class="form-control" name="descriptionEx" placeholder="Description Exercice *" value="<%=ex.getTempsBaseEx()%>" required/>
                                        </div>                                    
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ressourceEx" placeholder="Illusatration *" value="" required/>
                                        </div>
                                        <div class="form-group">
                                            <label>Durée :</label>
                                        ...
                                        <button type="submit" name="exerciceUpdate">Confirmer Modification</button>
