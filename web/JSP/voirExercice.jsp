                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name = "nomEx" class="form-control" placeholder="Nom Exercice *" value="<%= ex.getNomEx()%>" disabled/>
                                            <td><p id = "verifExiste" ></p></td>
                                        </div>

                                        <div class="form-group">
                                            <label>Type Exercice :</label>
                                            <select class="form-control"  name="typeEx" size="1" disabled >
                                                <option class="hidden"  selected disabled><%= ex.getTypeExercice().getLibTypeEx()%></option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Objectifs Exercice :</label>
                                            <input type="text" class="form-control" name="objectifsEx" placeholder="Objectifs Exercice *" value="<%= ex.getDescriptionEx()%>" disabled/>
                                        </div>
                                        <div class="form-group">
                                            <label>Précisions Exercice :</label>
                                            <input type="text" class="form-control" name="precisionEx" placeholder="Précision Exercice *" value="<%=ex.getTempsBaseEx()%>" disabled />
                                        </div>
                                        <div class="form-group">
                                            <label>Description Exercice :</label>
                                            <input type="text" class="form-control" name="descriptionEx" placeholder="Description Exercice *" value="<%=ex.getTempsBaseEx()%>" disabled/>
                                        </div>                                    
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ressourceEx" placeholder="Illusatration *" value="<%=ex.getRessourceEx() %>" disabled/>
                                        </div>
                                        <div class="form-group">
                                            <label>Durée :</label>
                                            <input type="int" class="form-control" name="tempsBaseEx" placeholder="Durée Exercice *" value="<%=ex.getTempsBaseEx()%>" disabled />
                                        </div>
                                        <div class="form-group">
                                            <label>Répétitions :</label>
                                            <input type="int" class="form-control" name="repsBaseEx" placeholder="Répétitions *" value="<%=ex.getRepsBaseEx()%>" disabled/>
                                            <span class="validity"></span>
                                        </div>                                      
                                        <div class="btn-group">
                                            <form action="modifExercice">
